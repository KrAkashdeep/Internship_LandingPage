...
const testimonials = [
  {
    id: 1,
    content:
      "InternHub helped me land my dream internship at Google. The platform is incredibly user-friendly, and the team provided valuable guidance throughout the application process.",
  ...
  },
  {
    id: 2,
    content:
      "As a business student, I was looking for an internship that would give me real-world experience. Thanks to InternHub, I found a marketing internship that perfectly matched my skills and interests.",
    author: "Michael Chen",
  ...
  },
  {
    id: 3,
    content:
      "The quality of internships on InternHub is unmatched. I was able to secure a position at a top financial firm, which has now turned into a full-time job offer after graduation!",
  ...
  },
  {
    id: 4,
    content:
      "What sets InternHub apart is their personalized approach. They don't just connect you with companies; they ensure the opportunities align with your career goals and aspirations.",
    author: "David Kim",
  ...
  },
  {
    id: 5,
    content:
      "I was struggling to find design internships until I discovered InternHub. Within two weeks, I had multiple interviews lined up and eventually accepted an amazing UX design role.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
            Hear from students who found their perfect internships through our
            platform
          </p>
        </div>
            ...
            <div className="md:flex">
              ...
              <div className="p-8">
                ...
                <div className="relative">
                  <svg
                    className="absolute top-0 left-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-sky-200"
                    fill="currentColor"
                    viewBox="0 0 32 32"
                    aria-hidden="true"
                  >
            ...
            <div className="md:flex md:items-center md:justify-between">
              <div className="md:w-2/3">
                ...
                <p className="mt-4 text-lg text-sky-100">
                  Join thousands of students who have launched their careers
                  through InternHub.
                </p>
              </div>
