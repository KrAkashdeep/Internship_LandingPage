        ...
        <div className="py-12 border-b border-gray-700">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-4 text-lg text-gray-300">
              Subscribe to our newsletter and never miss out on new internships and career tips.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-1">
              ...
              <p className="mt-2 text-base text-gray-400">
                Connecting talented students with premium internship opportunities since 2023.
              </p>
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-200 tracking-wider uppercase">For Students</h3>
